...
class ScannerPanel(QWidget):
    ...
    def _setup_ui(self):
        ...
        cap_group = QGroupBox("Nalezené stanice")
        cgl = QVBoxLayout(cap_group)
        self._chk_autocap = QCheckBox("Auto-import do Scan Bank")
        self._chk_autocap.setChecked(True)
        cgl.addWidget(self._chk_autocap)
        gl.addWidget(cap_group)
